#!/bin/sh
cd /home/ProvarDX/ProvarDX
scratch_org_alias=ProvarDX
# Authorize dev hub to generate scratch orgs
echo "Authorize Dev Hub in container"
sfdx force:auth:jwt:grant --clientid $CONSUMER_KEY --jwtkeyfile /home/ProvarDX/server.key --username $DEV_HUB_USERNAME --setdefaultdevhubusername --setalias $DEV_HUB_ALIAS --instanceurl $INSTANCE_URL
...
sfdx force:org:create -f /home/ProvarDX/ProvarDX/config/project-scratch-def.json --setalias $scratch_org_alias --durationdays $SCRATCH_ORG_DURATION --setdefaultusername --json --loglevel fatal 
...
/home/ProvarDX/create_connection_overrides.sh $CONNECTION_NAME $scratch_org_alias /home/ProvarDX/$PROVARDX_PROPERTY_FILE 
...
/home/ProvarDX/insert_secrets_password.sh $ProvarSecretsPassword /home/ProvarDX/$PROVARDX_PROPERTY_FILE 
# Deploy metadata to scratch org for admin user
echo "Retrieve metadata from Dev Hub and push to Scratch Org"
sfdx force:mdapi:retrieve -r package -u $DEV_HUB_USERNAME -k /home/ProvarDX/ProvarDX/package.xml 
unzip /home/ProvarDX/ProvarDX/package/unpackaged.zip 
sfdx force:mdapi:convert --home/ProvarDXdir /home/ProvarDX/ProvarDX/unpackaged --outputdir /home/ProvarDX/ProvarDX/force-app 
